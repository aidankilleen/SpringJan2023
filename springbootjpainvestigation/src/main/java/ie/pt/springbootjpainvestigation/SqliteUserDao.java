...
/**
 * ie.pt.springbootjpainvestigation.SqliteUserDao
 *
...
public class SqliteUserDao implements UserDao {
    ...
    /**
     * Instantiate a new ie.pt.springbootjpainvestigation.UserDao
    ...
    public User addUser(User newUser) throws UserDaoException {
        ...
        // you can't supply an id - to harmonise with the jpa and other user daos
        /*
        if (newUser.getId() != -1) {
