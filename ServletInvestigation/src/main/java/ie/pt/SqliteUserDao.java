...
public class SqliteUserDao implements UserDao {
    ...
    public SqliteUserDao(String databaseFile) throws UserDaoException {
        ...
        // ensure the db driver is loaded into memory
        // tomcat doesn't do this the way the console runtime did

        try {
            Class.forName("org.sqlite.JDBC");
        }catch(ClassNotFoundException ex) {
            throw new UserDaoException("Database driver not available");
        }
